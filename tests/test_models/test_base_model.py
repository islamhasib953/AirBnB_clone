...
class TestBaseModel(unittest.TestCase):
    ...
    def test_str(self):
        ...
        """
        strr="[{}] ({}) {}".format(self.my_model.__class__.__name__, self.my_model.id, self.my_model.__dict__)
    ...
    def test_to_dict(self):
        ...
        """
        dc=self.my_model.to_dict()
        self.assertEqual(dc["__class__"],"BaseModel")
        self.assertEqual(dc["created_at"],self.my_model.created_at.isoformat())
        self.assertEqual(dc["updated_at"],self.my_model.updated_at.isoformat())
        self.assertEqual(dc["id"],self.my_model.id)
